...
- Restaurant staff access now includes tenant-scoped menu, gallery, profile, settings, staff management foundation, reservations management, table management foundation, order status management foundation, public tenant order creation when enabled, and tenant table QR ordering when enabled.
...
- Assisted ordering, payments, kitchen automation, inventory consumption, recipes, staff invitations, audit logging, password reset flows, and other advanced tenant admin modules remain future work.
...
Assisted ordering, payments, kitchen automation, inventory consumption, recipes, staff invitations, audit logging, self-service password reset flows, billing, domains, email, and WhatsApp automation remain future work.
