      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <div className="flex justify-center gap-4">
            <Link href="/reservations"><Button>Reserve a Table</Button></Link>
            <Link href="/order"><Button className="bg-secondary">Order Online</Button></Link>
          </div>
        </motion.div>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {highlights.map((item) => (
            <motion.div key={item.title} whileHover={{ translateY: -6 }} className="section-bg p-4">
              ...
              <Link href="/menu" className="text-primary font-semibold">View Menu →</Link>
            </motion.div>
          ))}
        </div>
      </Section>
      ...
      <Section>
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <Link href="/about" className="text-primary font-semibold">Read our story →</Link>
          </div>
