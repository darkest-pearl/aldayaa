...
const navLinks = [
  ...
  { href: '/public/order-track', label: 'Track Order' },   // ⭐ NEW LINK HERE
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-3">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <Link
            ...
            className="bg-primary text-white px-4 py-2 rounded-full shadow hover:scale-105 transition-transform"
          >
            Reserve
          </Link>
        </nav>
